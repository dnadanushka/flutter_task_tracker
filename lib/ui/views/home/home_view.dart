...
import 'package:flutter_starter/ui/views/project_management/kanban_board.dart';
import 'package:flutter_starter/ui/views/project_management/notion_board.dart';
...
class HomeView extends ViewModelBuilderWidget<HomeViewModel> {
  ...
  Widget builder(BuildContext context, HomeViewModel viewModel, Widget? child) {
    ...
    return SizedBox(height: 1000,width:1000,child: MultiBoardListExample());
  }
